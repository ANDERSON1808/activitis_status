...
Database migrations are done automatically for the development environment is H2sql for production is MySql. You just
have to run the java application and the database is ready.
...
- To view the database online, enter the database administration panel.
- To look at the performance and administration of the monolith enter the administration panel.
...
To build the final jar and optimize the activitiesStatus application for production, run:
