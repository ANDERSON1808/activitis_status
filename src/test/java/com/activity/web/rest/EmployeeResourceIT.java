...
import com.activity.domain.Employee;
import com.activity.repository.EmployeeRepository;
...
class EmployeeResourceIT {
    ...
    public static Employee createEntity(EntityManager em) {
        Employee employee = new Employee().name(DEFAULT_NAME).created(DEFAULT_CREATED);
        return employee;
    }
    ...
    public static Employee createUpdatedEntity(EntityManager em) {
        Employee employee = new Employee().name(UPDATED_NAME).created(UPDATED_CREATED);
        return employee;
    }
    ...
    void putNewEmployee() throws Exception {
        ...
        updatedEmployee.name(UPDATED_NAME).created(UPDATED_CREATED);
    ...
    void partialUpdateEmployeeWithPatch() throws Exception {
        ...
        partialUpdatedEmployee.created(UPDATED_CREATED);
    ...
    void fullUpdateEmployeeWithPatch() throws Exception {
        ...
        partialUpdatedEmployee.name(UPDATED_NAME).created(UPDATED_CREATED);
